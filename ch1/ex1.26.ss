...
;; If using an explicit multiplication instead of calling square, the 2 expmod
;; will be evaluated before doing the multiplication. Each expmod procedure
;; will be expanded to another multiplication of two expmod procedure. So the 
;; total number of steps becomes 2^Theta(log n), which can be transformed to
;; Theta(n). 