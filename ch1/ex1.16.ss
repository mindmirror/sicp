...
;; way that the product a bn is unchanged from state to state. At the beginning
;; of the process a is taken to be 1, and the answer is given by the value of a
;; at the end of the process. In general, the technique of defining an invariant
